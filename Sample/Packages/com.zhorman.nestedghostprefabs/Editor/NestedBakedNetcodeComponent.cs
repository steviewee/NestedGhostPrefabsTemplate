...
using Zhorman.NestedGhostPrefabs.Runtime.Authoring;
    ...
    /// <summary>Internal structs used by the GhostComponentInspector to store post-conversion (i.e. NestedBaked) data.</summary>
    public class NestedBakedResult
    {
        public Dictionary<GameObject, NestedBakedGameObjectResult> GameObjectResults;
        public NestedGhostAuthoring GhostAuthoring;

        public NestedBakedGameObjectResult GetInspectionResult(NestedGhostInspectionAuthoring inspection)
        {
    ...
    public class NestedBakedGameObjectResult
    {
        public NestedBakedResult AuthoringRoot;
        public GameObject SourceGameObject;
        [CanBeNull] public NestedGhostInspectionAuthoring SourceInspection;
        public NestedGhostAuthoring RootAuthoring => AuthoringRoot.GhostAuthoring;
        public string SourcePrefabPath;
        public List<NestedBakedEntityResult> NestedBakedEntities;
        public int NumComponents;
    }

    /// <inheritdoc cref="NestedBakedGameObjectResult"/>
    public class NestedBakedEntityResult
    {
        public NestedBakedGameObjectResult GoParent;
        public Entity Entity;
        public EntityGuid Guid;
        public string EntityName;
        public int EntityIndex;
        public bool IsPrimaryEntity => EntityIndex == 0;
        public List<NestedBakedComponentItem> NestedBakedComponents;
    ...
    /// <inheritdoc cref="NestedBakedGameObjectResult"/>
    public class NestedBakedComponentItem
    {
        public NestedBakedEntityResult EntityParent;
        ...
        /// <summary>Lists all strategies available to this NestedBaked component.</summary>
        ...
        /// <summary>Returns true if this Inspection Component has a prefab override for this NestedBaked Component Type.</summary>
        ...
        public void RemoveEntirePrefabOverride(DropdownMenuAction action)
        {
            ...
            else NestedGhostInspectionAuthoring.forceSave = true;
        }
        ...
        public override string ToString() => $"NestedBakedComponentItem[{fullname} with {serializationStrategy}, {availableSerializationStrategies.Length} variants available, entityGuid: {entityGuid}]";
    }
