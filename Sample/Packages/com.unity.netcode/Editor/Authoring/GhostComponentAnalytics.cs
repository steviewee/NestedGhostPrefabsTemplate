...
namespace Unity.NetCode.Editor
{
    ...
    public struct GhostTypeData : IAnalytic.IData
#else
    ...
    /// </summary>
    [Serializable]
    public struct WrappedClientServerTickRate
    {
    ...
    /// </summary>
    [Serializable]
    public struct WrappedClientTickRate
    {
    ...
    [Serializable]
#if UNITY_2023_2_OR_NEWER
    public struct GhostScaleAnalyticsData : IAnalytic.IData
#else
    ...
    [Serializable]
    public struct PlaymodeSettings
    {
    ...
    public static class GhostComponentAnalytics
    {
