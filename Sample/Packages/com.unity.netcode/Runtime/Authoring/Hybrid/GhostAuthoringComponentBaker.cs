...
namespace Unity.NetCode
{
    ...
    public struct GhostPrefabConfigBaking
    {
    ...
    [BakingType]
    public struct GhostAuthoringComponentBakingData : IComponentData
    {
    ...
    [BakingType]
    public struct GhostAuthoringComponentOverridesBaking : IBufferElementData
    {
    ...
    [BakingType]
    public struct GhostChildEntityBaking : IComponentData
    {
    ...
    [BakingType]
    public struct GhostRootEntityBaking: IComponentData { }

    [UpdateInGroup(typeof(PostBakingSystemGroup))]
    [WorldSystemFilter(WorldSystemFilterFlags.BakingSystem)]
    [AlwaysSynchronizeSystem]
    [BakingVersion("cmarastoni", 1)]
    public partial class GhostAuthoringBakingSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            Entities
                .WithAll<GhostAuthoringComponentBakingData, LinkedEntityGroup>()//LinkedEntityGroup needs to be here---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            Entities.WithAll<GhostAuthoringComponentBakingData, LinkedEntityGroup>().ForEach((Entity rootEntity, DynamicBuffer<LinkedEntityGroup> linkedEntityGroup, in GhostAuthoringComponentBakingData ghostAuthoringBakingData) =>//LinkedEntityGroup needs to be here also---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            {
