...
namespace Unity.NetCode
{
    ...
    public struct ComponentTypeSerializationStrategy : IComparable<ComponentTypeSerializationStrategy>
    {
        ...
        public byte IsInput => (byte) (IsInputComponent | IsInputBuffer);
        ...
        public static FixedString32Bytes GetDefaultDisplayName(ComponentTypeSerializationStrategy.DefaultType defaultRule)
        {
    ...
    public partial class GhostComponentSerializerCollectionSystemGroup : ComponentSystemGroup
    {
        ...
        /// </summary>
        public GhostVariantRules DefaultVariantRules { get; private set; }
    ...
    public struct GhostComponentSerializerCollectionData : IComponentData
    {
        ...
        /// </summary>
        public NativeList<GhostComponentSerializer.State> Serializers;
        /// <summary>
        ...
        [BurstCompile]
        public ComponentTypeSerializationStrategy GetCurrentSerializationStrategyForComponent(ComponentType componentType, ulong chosenVariantHash, bool isRoot)
        {
        ...
        public ComponentTypeSerializationStrategy SelectSerializationStrategyForComponentWithHash(ComponentType componentType, ulong chosenVariantHash, in NativeList<ComponentTypeSerializationStrategy> available, bool isRoot)
        {
        ...
        public static bool AnyVariantsAreSerialized(in NativeList<ComponentTypeSerializationStrategy> availableVariants)
        {
