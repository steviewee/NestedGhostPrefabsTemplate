...
namespace NGPTemplate.Misc
{
    ...
    public class MobileGamepadBehaviour : MonoBehaviour
    {
        ...
        void SetupControlBindings()
        {
            m_ControlMap = new Dictionary<string, InputControl>
            {
                ...
                { nameof(MobileGamepadState.ButtonShoot), MapRuntimeControl(m_ShootAction) },
                { nameof(MobileGamepadState.ButtonAim), MapRuntimeControl(m_AimAction) },
                { nameof(MobileGamepadState.ButtonUp), MapRuntimeControl(m_UpAction) },
                { nameof(MobileGamepadState.ButtonDown), MapRuntimeControl(m_DownAction) },
